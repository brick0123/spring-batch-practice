package com.woodcock.batch.reader;
...
public class JpaPagingFetchItemReader<T> extends AbstractPagingItemReader<T> {
  ...
  /**
   * By default (true) the EntityTransaction will be started and committed around the read. Can be overridden (false) in cases where the JPA implementation doesn't support a particular transaction.
   * (e.g. Hibernate with a JTA transaction).  NOTE: may cause problems in guaranteeing the object consistency in the EntityManagerFactory.
   *
